...
include '../../../includes/crud/crud-materi/crud-materi.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    switch ($_POST['action']) {
        ...
        case 'get_by_id':
            $result = getMateriWhereId($_POST['id_materi']);
            echo json_encode($result);
            exit;
    }
}
...
<body class="bg-primary text-primary min-h-screen flex flex-col">
    ...
    <!-- Add/Edit Modal -->
    <div id="material-modal" class="fixed inset-0 bg-black bg-opacity-50 modal-backdrop z-50 hidden flex items-center justify-center p-4">
    ...
    console.log('Rendering materials:', filteredData);
    ...
    tableBody.innerHTML = pageData.map((material, index) => `
        <tr class="hover:bg-gray-50 transition-colors duration-150">
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                <button onclick="viewDetail(${material.id_materi})" class="text-blue-600 hover:text-blue-900">
                    <i class="fa-solid fa-eye"></i>
                </button>
                <button onclick="editMaterial(${material.id_materi})" class="text-indigo-600 hover:text-indigo-900">
                    <i class="fa-solid fa-edit"></i>
                </button>
                <button onclick="deleteMaterial(${material.id_materi})" class="text-red-600 hover:text-red-900">
...
function applyFilters() {
    ...
    console.log('Applying filters:', { searchTerm, selectedPelajaran });
...
async function loadMaterials() {
    ...
    loadingState.classList.add('hidden');
        ...
        async function editMaterial(id) {
            const result = await sendAjaxRequest('get_by_id', { id_materi: id });
                ...
                document.getElementById('detail-content').innerHTML = `
                    <div class="space-y-6">
                        ...
                        <div class="flex justify-end space-x-3">
                            <button onclick="closeDetailModal()" class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50">
                                Tutup
                            </button>
                            <button onclick="editMaterial(${material.id_materi}); closeDetailModal();" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
        ...
        async function deleteMaterial(id) {
            if (confirm('Apakah Anda yakin ingin menghapus materi ini?')) {
                const result = await sendAjaxRequest('delete', { id_materi: id });
