...
<head>
    ...
    <title>Admin Dashboard - <?= $username; ?></title>
        ...
        <main class="p-6">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="content-card rounded-lg p-6 bg-white shadow-md">
                        <div class="flex items-center">
                            <div class="w-16 h-16 rounded-full flex items-center justify-center bg-red-200 mr-3">
                                <i class="fa-solid fa-check text-2xl text-red-600"></i>
                            </div>
                            <div class="ml-4">
                                <h3 class="text-base font-semibold mb-2">Jumlah Tutor yang Belum Absen</h3>
                                <h3 class="text-5xl font-semibold mb-2 text-red-600">36</h3>
                                <p class="text-muted">Tutor Belum Absen</p>
                            </div>
                        </div>
                    </div>
                </div>
